---
name: math-error-notebook-harness
description: Manage a Chinese high-school math error notebook with Codex plus a guarded DeepSeek Harness and one local verified question bank. Use for photographed or typed Grade 10-12 math grading, verification, recommendations, PDF output, imports, and reviews when DeepSeek should handle bounded text tasks while Codex retains vision, escalation, and final database-write review.
---

# 李兆霖数学错题本（Codex + Harness 省 Token 版）
